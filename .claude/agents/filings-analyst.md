...
description: Reads the filings plane for tracked-investor and insider activity on a name. This is the filings and news ingestion-facing role and has no write tool of any kind. Returns positions with staleness in days and portfolio share, or unknown.
