...
| `claude/notify-email-cards` | Resend email channel, HTML cards, the signed card page (`notify/`) | worker | opening |

Every Strategy Lab and Investment Workspace build PR is on `main`.
