...
- [ ] **P1 (review) — Spec J: event-replay backtester** (`BRY-306`, `t_8308adac`, in review) — J1 exit simulator + J2 event-anchored replay + J3 param sweep + J4 shadow-ledger adapter (`specs/audit-2026-07-04/J-event-replay-backtester.md`). Two open PRs to compare: [#37](https://github.com/niyonzimabryan/swingtrader/pull/37) (independent Opus impl, branch `claude/spec-j-backtester-opus`) and [#36](https://github.com/niyonzimabryan/swingtrader/pull/36) (Codex, branch `claude/spec-j-backtester`) — pick one to land, close the other. Suite green (pytest 317 / unittest 311 / compileall). LLM-stage replay permanently out of scope by design. Prod-container run is an ops step (see PR runbook).
