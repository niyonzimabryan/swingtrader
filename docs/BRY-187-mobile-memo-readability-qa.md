# BRY-187 Mobile Memo Readability QA

Scope: Telegram MarkdownV2 memo readability on a 390px-wide mobile viewport.

Note: This run did not start the live Telegram bot because Railway may be polling the same bot token. The QA evidence uses the local MarkdownV2 memo renderer with three representative `/test`-style memo payloads: `NVDA` / proceed, `AAPL` / watchlist, and `MSFT` / pass.

## Before / after grid

| Before | After |
| --- | --- |
| ![Before mobile memo preview](assets/bry-187-mobile-memo-qa/before.png) | ![After mobile memo preview](assets/bry-187-mobile-memo-qa/after.png) |
...
- Added a deterministic local QA renderer at `scripts/render_memo_mobile_qa.py` for repeatable 390px memo previews without touching Telegram or the live Railway bot.
...
- `docs/assets/bry-187-mobile-memo-qa/before.html`
- `docs/assets/bry-187-mobile-memo-qa/before.png`
- `docs/assets/bry-187-mobile-memo-qa/before-NVDA.md`
- `docs/assets/bry-187-mobile-memo-qa/before-AAPL.md`
- `docs/assets/bry-187-mobile-memo-qa/before-MSFT.md`
- `docs/assets/bry-187-mobile-memo-qa/after.html`
- `docs/assets/bry-187-mobile-memo-qa/after.png`
- `docs/assets/bry-187-mobile-memo-qa/after-NVDA.md`
- `docs/assets/bry-187-mobile-memo-qa/after-AAPL.md`
- `docs/assets/bry-187-mobile-memo-qa/after-MSFT.md`
