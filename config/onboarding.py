...
ENV_GROUPS = [
    ...
    },
    {
        ...
        "summary": "Selects review, paper, or Robinhood Agentic live execution.",
    },
    {
        "id": "market_data",
        "label": "Market Data",
...
ENV_FIELDS = [
    ...
    EnvField(
        ...
        group="broker",
        description="Optional. Use alpaca for paper-first setup or robinhood for Agentic live review/execution.",
        required=False,
        secret=False,
        default="alpaca",
        placeholder="alpaca",
    ...
    EnvField(
        ...
        label="Paper broker",
        group="broker",
        description="Optional. Alpaca remains the supported paper broker.",
        required=False,
        secret=False,
        default="alpaca",
        placeholder="alpaca",
    ...
    EnvField(
        ...
        group="broker",
        description="Optional. review_only stores broker reviews, paper places Alpaca paper trades, live places primary-broker trades when live is explicitly enabled.",
        required=False,
        secret=False,
        default="paper",
        placeholder="paper",
    ...
    EnvField(
        ...
        group="broker",
        description="Optional hard gate for live broker placement. Keep false until Robinhood Agentic account and caps are verified.",
        required=False,
        secret=False,
        default="false",
        placeholder="false",
    ...
    EnvField(
        ...
        label="Robinhood MCP URL",
        group="broker",
        description="Optional. Official Robinhood Agentic Trading MCP endpoint.",
        required=False,
        secret=False,
        default="https://agent.robinhood.com/mcp/trading",
        placeholder="https://agent.robinhood.com/mcp/trading",
        signup_url="https://robinhood.com/us/en/agentic-trading/",
    ),
    EnvField(
        name="ROBINHOOD_ACCOUNT_NUMBER",
        label="Robinhood account number",
        group="broker",
        description="Optional. Dedicated Agentic account number used by review/order tools.",
        required=False,
        placeholder="agentic account number",
        signup_url="https://robinhood.com/us/en/agentic-trading/",
    ),
    EnvField(
        name="ROBINHOOD_ACCOUNT_BUDGET",
        label="Robinhood account budget",
        group="broker",
        description="Optional. Local budget reference for the small Agentic account.",
        required=False,
        secret=False,
        default="25",
        placeholder="25",
    ...
    EnvField(
        name="ROBINHOOD_MAX_ORDER_NOTIONAL",
        label="Robinhood max order",
        group="broker",
        description="Optional. Per-order live notional cap.",
        required=False,
        secret=False,
        default="5",
        placeholder="5",
    ...
    EnvField(
        name="ROBINHOOD_MAX_DAILY_NOTIONAL",
        label="Robinhood daily cap",
        group="broker",
        description="Optional. Daily live notional cap across Robinhood orders.",
        required=False,
        secret=False,
        default="10",
        placeholder="10",
    ...
    EnvField(
        name="ROBINHOOD_MAX_OPEN_POSITIONS",
        label="Robinhood max positions",
        group="broker",
        description="Optional. Max concurrent Robinhood positions for the Agentic account.",
        required=False,
        secret=False,
        default="3",
        placeholder="3",
    ...
    EnvField(
        name="ROBINHOOD_ORDER_TYPE",
        label="Robinhood order type",
        group="broker",
        description="Optional. market supports capped dollar/fractional micro-orders; limit requires whole-share sizing.",
        required=False,
        secret=False,
        default="market",
        placeholder="market",
