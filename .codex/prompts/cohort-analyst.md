...
`.claude/agents/cohort-analyst.md` brief reproduced as a pasteable prompt: paste
...
The brief below is generated from `.claude/agents/cohort-analyst.md` and
